...
.PHONY: all check check-dependencies check-filesystem check-glibc check-linux-api-headers

all: check

check: check-filesystem check-dependencies check-linux-api-headers check-glibc
